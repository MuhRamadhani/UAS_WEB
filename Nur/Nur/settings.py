...
SECRET_KEY = 'django-insecure-1te)iy+$^6^%2y7(8x+(d_l0ij2!^mgwtf(#y!%3xfu%004%+4'
...
LOGOUT_REDIRECT_URL = '/'
LOGIN_URL = '/authentikasi/login' #Ketika user belum login maka diarahkan ke Login Page
